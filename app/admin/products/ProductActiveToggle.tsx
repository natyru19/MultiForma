...
export default function ProductActiveToggle({ productId, active: initialActive }: Props) {
    ...
    return (
        <div className="flex flex-col items-end gap-1">
            <button
                ...
                role="switch"
                aria-checked={active}
                aria-label={active ? "Producto activo" : "Producto inactivo"}
                disabled={loading}
            ...
            >
                {loading ? "Guardando..." : active ? "Activo" : "Inactivo"}
            </span>
